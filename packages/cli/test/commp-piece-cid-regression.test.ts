...
import { PINNED_CARS } from './pinned-cars.ts'
...
// The pinned values live in pinned-cars.ts, shared with the hermetic replay
// (commp-fixture-parity.test.ts) so this canary and the merge gate can never
// disagree about what was pinned — only about what the live gateway serves.
const KNOWN = PINNED_CARS
